...
VALUES
    (19,9,'2022-06-13 13:00:00','배송완료',30000),
    (20,9,'2022-06-13 13:00:00','배송완료',40000),
    (21,9,'2022-06-13 13:00:00','배송완료',20000),
    (22,10,'2023-06-13 13:00:00','배송완료',50000),
    (23,11,'2023-06-13 13:00:00','배송완료',10000),
    (24,12,'2023-06-13 13:00:00','배송완료',30000),
    (25,13,'2023-06-13 13:00:00','배송완료',40000),
    (26,13,'2024-06-13 13:00:00','배송완료',20000),
    (27,8
,'2024-06-13 13:00:00','배송완료',60000),
    (28,8,'2024-06-13 13:00:00','배송완료',32000);
...
INSERT INTO
    refund
VALUES
    (null, 4, '2023-06-04 13:00:00', '처리완료', '단순변심', '변경하고싶어요.', '반려', 'Y'),
    (null, 5, '2023-06-05 14:00:00', '처리중', '상품불량', '상품에 문제가 있네요.', '확정', 'N'),
    (null, 6, '2023-06-06 15:00:00', '처리대기', '상품불량', '상품에 이물질이 묻었어요.', null, 'N'),
    (null, 11, '2023-06-11 10:00:00', '처리완료', '단순변심', '변경하고싶어요.', '반려', 'Y'),
    (null, 19, '2022-06-13 13:00:00', '처리중', '상품불량', '상품에 문제가 있네요.', '확정', 'Y'),
    (null, 20, '2022-06-13 13:00:00', '처리대기', '상품불량', '상품에 이물질이 묻었어요.', null, 'N'),
    (null, 22, '2023-06-13 13:00:00', '처리대기', '상품불량', '글자수테스트중입니다글자수테스트중입니다글자수테스트중입니다글자수테스트중입니다글자수테스트중입니다글자수테스트중입니다글자수테스트중입니다글자수테스트중입니다글자수테스트중입니다글자수테스트중입니다', null, 'N'),
    (null, 23, '2023-06-13 13:00:00', '처리완료', '단순변심', '변경하고싶어요.', '반려', 'Y'),
    (null, 25, '2023-06-13 13:00:00', '처리중', '상품불량', '상품에 문제가 있네요.', '확정', 'N'),
    (null, 26, '2024-06-13 13:00:00', '처리대기', '상품불량', '상품에 이물질이 묻었어요.', null, 'N'),
    (null, 27, '2024-06-13 13:00:00', '처리완료', '단순변심', '변경하고싶어요.', '반려', 'Y'),
    (null, 28, '2024-06-13 13:00:00', '처리완료', '단순변심', '변경하고싶어요.', '반려', 'Y');
