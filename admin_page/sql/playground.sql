...
select *
from user;
INSERT INTO user (user_id, user_name, user_email, user_email_able, address, join_date, last_connect, user_pet,
                  dormant_user)
VALUES (1, '홍길동', 'john.doe@example.com', TRUE, '서울특별시 광진구', '2022-01-01', '2023-06-20', 'Dog', false),
...
VALUES (1, 1, '2023-06-01 10:00:00', '입금전', 360000),
...
select *
from product;
INSERT INTO product (product_id, product_name, category, product_image, product_desc, price, amount, is_display,
                     product_status, created_at)
VALUES (1, '강아지 사료', '사료', NULL, '프리미엄 건식 사료', 50000, 100, TRUE, '판매중', '2024-06-01'),
...
VALUES ('admin01', '12341234', 'SUPER'),
       ('admin02', 'zxasqw12', 'STANDARD'),
